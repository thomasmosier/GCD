...
elseif regexpbl(strMethod, 'tlapse')
    if regexpbl(tPeriod, 'pro')
        ...
        dataInfo = {...
            varDs, 'proj_sim_ts', 'low-resolution projection simulation time-series';...
            varDs, 'hist_sim_ts', 'low-resolution historical simulation time-series'; ...
            'z', 'lr_dem', 'low-resolution DEM aligning with simulation'; ...
            'z', 'hr_dem', 'output-resolution DEM for deriving output elevation'; ...
...
elseif regexpbl(strMethod, 'roe') %Roe orographic model
    if regexpbl(tPeriod, 'pro')
        ...
        dataInfo = {...
            ...
            'z', 'lr_dem', 'low-resolution DEM aligning with low-resoltuion input simulation'; ...
            'z', 'hr_dem', 'output-resolution DEM aligning with output-resolution temperature simulation'; ...
            };
%         dataInfo = {...
%             varDs, 'proj_sim_ts', 'low-resolution projection simulation time-series';...
% %             varDs, 'hist_sim_ts', 'low-resolution historical simulation time-series'; ...
