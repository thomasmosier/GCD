...
for nn = 1 : numel(datesMod2BcLp(:,1))
    ...
    if (numel(indHistModCurr) < 30*28 && nn == 1) &&  blWarn == 1
        warning('bc1dDay:lowModTs', ...
            ...
            'current time step (approx ' num2str(round(numel(indHistModCurr)/365)) ...
            ' years). Usually 30 years of data is recommended.']);
    end
    if (numel(indHistRefCurr) < 30*28 && nn == 1) &&  blWarn == 1
        warning('bc1dDay:lowRefTs', ...
            ...
            'current time step (approx ' num2str(round(numel(indHistRefCurr)/365)) ...
            ' years). Usually 30 years of data is recommended.']);
    end
