...
yrsClim = [1970, 2000]; %Format = [1st year, end year] of climatology. 
...
ghcnStats = {'joint','adj','non','adj_cdf','non_cdf'};
%ghcnStats = {}; 
                                %'adj' = calculate GHCN statistics based on 
                                    %time-series analysis using adjusted 
                                    %GHCN data
                                %'non' = calculate GHCN statistics based on 
                                    %time-series analysis using adjusted 
